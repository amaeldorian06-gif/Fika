...
import { displayPrice, getCityPricing, priceNote, pricingMode, travelLabel } from '../lib/pricing';
          ...
          <div className="lg:col-span-2 space-y-8">
            <motion.div {...fadeUp(0.05)}>
              <div className="flex flex-wrap items-center gap-2 mb-5">
                ...
                {service.deliveryIncluded && pricingMode(service) === 'STANDARD' && (
          ...
          <div className="lg:col-span-1">
            ...
            >
              <p className="text-xs font-bold text-brand-text-muted uppercase tracking-wider mb-2">
                {pricingMode(service) === 'STANDARD' ? 'Tarif — Ngaoundéré' : 'Prix — Ngaoundéré'}
              </p>
              ...
              <ul className="space-y-4 pt-6 border-t border-brand-border">
                ...
                <li className="flex items-center gap-3 text-sm font-medium text-brand-text-muted">
                  <Truck className="w-5 h-5 text-brand-accent shrink-0" /> {travelLabel(service)}
                </li>
                <li className="flex items-center gap-3 text-sm font-medium text-brand-text-muted">
                  <ShieldCheck className="w-5 h-5 text-brand-accent shrink-0" /> Professionnel sélectionné et suivi par Fika
                </li>
                <li className="flex items-center gap-3 text-sm font-medium text-brand-text-muted">
