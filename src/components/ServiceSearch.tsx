...
import { getCategories, getServiceBySlug, getServices } from '../lib/catalog';
import { displayPrice, getCityPricing, travelLabel } from '../lib/pricing';
...
const POPULAR_SHORTCUTS = [
  { label: 'Dépannage Plomberie', slug: 'intervention-plomberie', category: 'Maison & Travaux' },
  { label: 'Dépannage Électricité', slug: 'intervention-electricite', category: 'Maison & Travaux' },
  { label: 'Réparation téléphone', slug: 'reparation-telephone', category: 'Réparation' },
  { label: 'Déménagement local', slug: 'demenagement-local', category: 'Transport' },
];

function shortcutPrice(slug: string): string {
                        ...
                        >
                          ...
                          <div className="text-right shrink-0">
                            ...
                            <span className="text-[10px] font-semibold text-brand-wa inline-flex items-center gap-1">
                              <Check className="w-3 h-3" /> {travelLabel(s)}
                            </span>
                          </div>
                        </button>
                      );
