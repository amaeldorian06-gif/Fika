          ...
          <>
            <Section title="1. Éditeur du site">
              ...
              <ul className="list-disc pl-5 space-y-1">
                {/* <li>Forme juridique : <strong>SARL (En cours d'immatriculation)</strong></li>
                <li>Registre du Commerce et du Crédit Mobilier (RCCM) : <strong>RC/YAO/2026/B/1234 </strong></li> */}
                ...
                <li>E-mail : <strong>amaeldorian@gmail.com</strong></li>
              </ul>
            </Section>
          ...
          <>
            <Section title="1. Responsable du traitement">
              <p>
                ...
                {SITE_CITY} (Cameroun) — RCCM <strong>RC/YAO/2026/B/1234</strong>, NIU <strong>M123456789012A</strong>.
