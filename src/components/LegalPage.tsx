          ...
          <>
            <Section title="1. Éditeur du site">
              ...
              <ul className="list-disc pl-5 space-y-1">
                {/* RCCM : à ajouter dès réception de l'immatriculation (numéro réel uniquement). */}
                <li>Numéro d&apos;Identification Unique des Contribuables (NIU) : <strong>P020818875410S</strong></li>
                <li>Siège social : <strong>Quartier Administratif</strong>, {SITE_CITY}, Cameroun</li>
                ...
                <li>E-mail : <strong>amaeldorian06@gmail.com</strong></li>
              </ul>
            </Section>

            <Section title="2. Directeur de la publication">
              <p>Directeur de la publication : <strong>Amaël Dorian</strong> (fondateur de {SITE_NAME}).</p>
            </Section>

            <Section title="3. Hébergement">
              <p>
                Le site est hébergé par : <strong>Vercel Inc.</strong> (440 N Barranca Ave, Covina, CA 91723, USA) ;
                base de données hébergée par <strong>Supabase Inc.</strong> (région Union européenne, Irlande).
              </p>
            </Section>
          ...
          <>
            <Section title="1. Responsable du traitement">
              <p>
                ...
                {SITE_CITY} (Cameroun) — NIU <strong>P020818875410S</strong>.
            ...
            <Section title="5. Durées de conservation">
              <ul className="list-disc pl-5 space-y-1.5">
                ...
                <li>Durée consolidée à valider par le conseil : <strong>12 mois</strong>.</li>
              </ul>
            </Section>
          ...
          <>
            ...
            <Section title="3. Prix">
              <p>
                ...
                lancement, sur devis écrit. Les interventions (plomberie, électricité, réparation, dépannage, transport)
                et les travaux (maçonnerie, peinture, carrelage, toiture, menuiserie) sont affichés « Devis selon le
                besoin » ou « Sur devis » : {SITE_NAME} établit alors un prix final comprenant le coût du professionnel,
                son déplacement, le matériel éventuel et sa marge de coordination. Ce prix est communiqué par écrit et
                validé par le client avant tout démarrage.
              </p>
            </Section>
            ...
            <Section title="4. Paiement et facturation">
              <p>
                ...
                de la prestation : <strong>immédiate</strong>. Une facture est délivrée pour chaque prestation exécutée.
              </p>
            </Section>
            ...
            <Section title="7. Livraison">
              <p>
                Pour les prestations impliquant un déplacement (interventions, travaux, transport), le déplacement du
                professionnel est <strong className="text-brand-text">organisé par {SITE_NAME} et intégré au devis validé</strong> :
                aucun frais de déplacement n&apos;est ajouté après acceptation. Pour les petites commandes de documents
                (CV, impressions), la livraison est <strong className="text-brand-text">incluse dans toute la ville de {SITE_CITY}</strong>.
              </p>
            </Section>
            ...
            <Section title="9. Garantie et reprise">
              <p>
                ...
                <strong> le remboursement intégral</strong> (barème de garantie). Les garanties légales impératives demeurent applicables.
              </p>
            </Section>
            ...
            <Section title="12. Réclamations">
              <p>
                ...
                <a href={`https://wa.me/${WHATSAPP_PHONE_E164.replace(/^\+/, '')}`} className="text-brand-wa font-bold hover:underline">{WHATSAPP_PHONE_E164}</a>{' '}
                à la livraison ou dans le délai précisé à la commande (<strong>48 heures maximum</strong>). Elle est examinée de bonne foi.
              </p>
            </Section>
