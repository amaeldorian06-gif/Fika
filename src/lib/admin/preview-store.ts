...
const INITIAL_ORDERS: StoredOrder[] = [
  {
    ...
    events: [
      { id: 'ev-1', from: null, to: 'NEW', note: 'Créée depuis demande WhatsApp.', actorEmail: 'amaeldorian06@gmail.com', createdAt: new Date(Date.now() - 36 * 3600 * 1000).toISOString() },
      { id: 'ev-2', from: 'NEW', to: 'QUALIFYING', note: 'Brief validé.', actorEmail: 'amaeldorian06@gmail.com', createdAt: new Date(Date.now() - 32 * 3600 * 1000).toISOString() },
      { id: 'ev-3', from: 'QUALIFYING', to: 'PAID', note: 'Paiement MoMo confirmé.', actorEmail: 'amaeldorian06@gmail.com', createdAt: new Date(Date.now() - 28 * 3600 * 1000).toISOString() },
      { id: 'ev-4', from: 'PAID', to: 'ASSIGNED', note: 'Expert assigné : Jean-Marc.', actorEmail: 'amaeldorian06@gmail.com', createdAt: new Date(Date.now() - 24 * 3600 * 1000).toISOString() },
      { id: 'ev-5', from: 'ASSIGNED', to: 'IN_PROGRESS', note: 'Première ébauche transmise.', actorEmail: 'amaeldorian06@gmail.com', createdAt: new Date(Date.now() - 12 * 3600 * 1000).toISOString() },
    ],
  ...
  },
  {
    ...
    events: [
      { id: 'ev-6', from: null, to: 'NEW', note: 'Demande site reçue.', actorEmail: 'amaeldorian06@gmail.com', createdAt: new Date(Date.now() - 48 * 3600 * 1000).toISOString() },
      { id: 'ev-7', from: 'NEW', to: 'QUALIFYING', note: 'Besoins détaillés.', actorEmail: 'amaeldorian06@gmail.com', createdAt: new Date(Date.now() - 40 * 3600 * 1000).toISOString() },
      { id: 'ev-8', from: 'QUALIFYING', to: 'QUOTED', note: 'Devis DEV-2026-0002 émis (35 000 F).', actorEmail: 'amaeldorian06@gmail.com', createdAt: new Date(Date.now() - 24 * 3600 * 1000).toISOString() },
    ],
    tasks: [],
  ...
  },
  {
    ...
    events: [
      { id: 'ev-9', from: null, to: 'NEW', note: 'Appareil déposé.', actorEmail: 'amaeldorian06@gmail.com', createdAt: new Date(Date.now() - 72 * 3600 * 1000).toISOString() },
      { id: 'ev-10', from: 'NEW', to: 'COMPLETED', note: 'Réparé et livré avec succès.', actorEmail: 'amaeldorian06@gmail.com', createdAt: new Date(Date.now() - 12 * 3600 * 1000).toISOString() },
    ],
  ...
  },
  {
    ...
    events: [{ id: 'ev-11', from: null, to: 'COMPLETED', note: 'CV livré et validé par le client.', actorEmail: 'amaeldorian06@gmail.com', createdAt: new Date(Date.now() - 48 * 3600 * 1000).toISOString() }],
    ...
    events: [
      {
        ...
        to,
        note: note ?? null,
        actorEmail: 'amaeldorian06@gmail.com',
...
export function previewConvertLead(leadId: string): { orderId: string; orderNumber: string } {
  ...
  const newOrder: StoredOrder = {
    ...
    costs: [],
    events: [{ id: `ev-${Date.now()}`, from: null, to: 'QUALIFYING', note: `Créée depuis la demande ${lead?.code ?? ''}.`, actorEmail: 'amaeldorian06@gmail.com', createdAt: new Date().toISOString() }],
    tasks: [],
    payments: [],
    deliveries: [],
    quotes: [],
...
export function previewAssignExpert(orderId: string, expertId: string, compensation?: number): string {
  ...
  orders[orderIdx] = {
    ...
    events: [{ id: `ev-${Date.now()}`, from: current.status, to: current.status, note: `Expert assigné : ${expert.name}.`, actorEmail: 'amaeldorian06@gmail.com', createdAt: new Date().toISOString() }, ...current.events],
  };
  saveStoredOrders(orders);
  return taskId;
}
